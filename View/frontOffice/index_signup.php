...
<body>
        ...
        <div class="container">
            <div class="top-header d-none d-sm-flex justify-content-between align-items-center">
                ...
                <nav class="d-flex aic">
                    <!--<a href="../backOffice/signIn.html" class="login"><i class="fa fa-user" aria-hidden="true"></i>Login</a>-->
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide slide-content d-flex align-items-center">
                                <div class="single-slide">
                                    ...
                                    <a data-aos="fade-right" data-aos-delay="900" href="../backOffice/addUser.php" class="btn btn-primary">sign up</a>
                                </div>
                            </div>
                            <div class="swiper-slide slide-content d-flex align-items-center">
                                <div class="single-slide">
                                    ...
                                    <a data-aos="fade-right" data-aos-delay="900" href="#" class="btn btn-primary">See More</a>
                                    <a data-aos="fade-right" data-aos-delay="900" href="../backOffice/signIn.php" class="btn btn-primary">sign in</a>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Featured End -->
    <!-- Recent Posts Start -->
    <section id="activities" class="recent-posts">
        <div class="container">
            <div class="title text-center">
                <h6>Offers</h6>
                <h1 class="title-blue">Our activities</h1>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-right"
                        ...
                        <div class="post-content text-sm-right">
                            <time datetime="2019-04-06T13:53">21 Apr, 2025</time>
                            <h3><a href="#">Pack your bags and join us</a></h3>
                            <p><a href="#">Seanding</a>, <a href="#">Website</a>, <a href="#">E-commerce</a></p>
                            <a class="post-btn" href="#"><i class="fa fa-arrow-right"></i></a>
                        </div>
                        <div class="post-thumb">
                            <img class="img-fluid"  src="assets/images/camping.jpeg" alt="Post 1">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-left" data-aos-duration="800">
                        <div class="post-thumb">
                            <img class="img-fluid"  src="assets/images/musicstream.jpg" alt="Post 1">
                        </div>
                        <div class="post-content">
                            <time datetime="2019-04-06T13:53">15 Apr, 2025</time>
                            <h3><a href="#">Tune in and vibe with us</a></h3>
                            <p><a href="#">Seanding</a>, <a href="#">Website</a>, <a href="#">E-commerce</a></p>
                            <a class="post-btn" href="#"><i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-right" data-aos-delay="200"
                        data-aos-duration="800">
                        <div class="post-content text-sm-right">
                            <time datetime="2019-04-06T13:53">20 Apr, 2025</time>
                            <h3><a href="#">Get ready for an epic movie marathon</a></h3>
                            <p><a href="#">Seanding</a>, <a href="#">Website</a>, <a href="#">E-commerce</a></p>
                            <a class="post-btn" href="#"><i class="fa fa-arrow-right"></i></a>
                        </div>
                        <div class="post-thumb">
                            <img class="img-fluid" src="assets/images/moviestream.jpeg" alt="Post 1">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-left" data-aos-delay="200"
                        data-aos-duration="800">
                        <div class="post-thumb">
                            <img class="img-fluid"  src="assets/images/yoga.jpeg" alt="Post 1">
                        </div>
                        <div class="post-content">
                            <time datetime="2019-04-06T13:53">16 Apr, 2025</time>
                            <h3><a href="#">Take a deep breath and enjoy</a></h3>
                            <p><a href="#">Seanding</a>, <a href="#">Website</a>, <a href="#">E-commerce</a></p>
                            <a class="post-btn" href="#"><i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
