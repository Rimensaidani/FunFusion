    ...
    <?php else: ?>
        <?php foreach ($posts as $post): ?>
            <div class="post-card p-3 mb-4 border rounded shadow-sm bg-white">
                ...
                <a href="index.php?action=delete_post&post_id=<?php echo $post['id']; ?>" class="btn btn-danger btn-sm">Delete Post</a>
                    ...
                    <?php else: ?>
                        <?php foreach ($comments as $comment): ?>
                            <div class="comment p-3 mb-2 bg-light border-left border-primary rounded">
                                ...
                                <a href="index.php?action=delete_comment&comment_id=<?php echo $comment['id']; ?>&post_id=<?php echo $comment['post_id'];  ?>" class="btn btn-danger btn-sm">Delete Comment</a>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
